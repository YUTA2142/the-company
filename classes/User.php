...
class User extends Database{
    ...
    public function login($request)
        {
            ...
            if($result->num_rows == 1){
                ...
                // SELECT `id`, `first_name`, `last_name`, `username`, `password`, `photo` FROM `users` WHERE 1
    ...
    public function getUser()
    {
        ...
        $sql = "SELECT `id`, `first_name`, `last_name`, `username`, `password`, `photo` FROM `users` WHERE id = $id";
